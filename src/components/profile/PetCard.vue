<template>
  <div class="card">
    ...
    <span class="text">{{ pet.gender }}</span>
    ...
    <button>
      ...
      <svg width="30" height="22" viewBox="0 0 30 22" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M15.8939 3.56857C16.7582 1.10565 19.135 -0.40999 21.2238 0.158375C23.2405 0.726741 24.1768 3.18966 23.3125 5.58943C22.4482 8.05235 20.0714 9.56799 17.9826 8.99962C15.9659 8.49441 15.0296 6.03149 15.8939 3.56857Z"/>
        <path d="M27.8502 6.53479C25.9775 6.02958 23.8168 7.48207 22.9525 9.81868C22.0882 12.1553 22.8804 14.4919 24.7531 14.9971C26.6257 15.5023 28.7865 14.0499 29.6508 11.7132C30.5151 9.37662 29.7228 7.04001 27.8502 6.53479Z"/>
        <path d="M12.0766 9.18785C14.0213 8.68263 14.8136 6.21971 13.8773 3.69364C12.9409 1.16757 10.5641 -0.411225 8.61945 0.0939891C6.67478 0.662355 5.88251 3.12527 6.81883 5.58819C7.82718 8.11427 10.132 9.75621 12.0766 9.18785Z"/>
